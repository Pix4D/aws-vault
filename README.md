...
[![Downloads](https://img.shields.io/github/v/release/pix4d/aws-vault)](https://github.pix4d/aws-vault/releases)

This is a Pix4D fork of the `aws-vault` originally developped by 99designs.
...
- by downloading the [latest release](https://github.com/pix4d/aws-vault/releases/latest)
